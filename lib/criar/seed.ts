...
export function ensureSeeded(): CriarChild {
  ...
  const pack: CriarPack = {
    ...
    phrases: [
      ...
      phrase("¿Tienes sueñito, Teo?", "Are you sleepy, Teo?"),
      phrase("Ven, upa, que te llevo a la cuna.", "Come here, up you come — I'll carry you to your cot.", "«Upa» is what Argentine parents say when picking a baby up."),
      ...
      phrase("Cierra esos ojitos.", "Close those little eyes."),
      ...
      phrase("Sueña con cosas lindas.", "Dream of lovely things."),
